...
export default function Grade(props) {
  ...
  const [CourseComponentOpt, setCourseComponent] = useState(AssessmentData.CourseComponent)
  const [TotalMarks, setTotalMarks] = useState(AssessmentData.TotalMarks)
  const [AttemptsAllowed, setAttemptsAllowed] = useState(AssessmentData.AttemptsAllowed)
  ...
  return (
    <Box className={classes.container} mt={2}>
      <Typography className={classes.header}>{t('labels:Grade_settings')}</Typography>
      ...
      <Grid container md={8} item sm={8} className={classes.KenInputsMargin}>
        <Grid item xs={12} sm={3} md={3}>
          <KenInputField
            ...
            setFieldTouched={setFieldTouched}
            name="totalMarks"
            defaultValue={() => { setFieldValue('totalMarks', 0) }}
            onChange={newValue => { setFieldValue('totalMarks', newValue.target.value); }}
        ...
        <Grid item xs={12} md={4} sm={4} className={classes.boxMargin}>
          <Typography className={classes.gradeLabel}>{t('GradeLabels:Grade_To_Pass_Assessment')}</Typography>
          {/* <Grid container> */}
          <Grid sm={12} md={12}>
            <KenInputField
              ...
              setFieldTouched={setFieldTouched}
              name="gradetopass"
              defaultValue={() => { setFieldValue('gradetopass', 0) }}
              onChange={newValue => { setFieldValue('gradetopass', newValue.target.value); }}
      ...
      <Grid item sm={6} className={classes.KenInputsMargin}>
        <KenSelect
          ...
          onChange={newValue => { setFieldValue('attemptsAllowed', newValue.target.value); }}
          setFieldTouched={setFieldTouched}
