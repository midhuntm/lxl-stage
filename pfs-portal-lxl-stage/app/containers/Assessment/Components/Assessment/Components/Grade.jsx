...
export default function Grade(props) {
  ...
  return (
    <Box className={classes.container} mt={2}>
      ...
      <Grid item container md={12}>
        <Grid xs={12} md={3}>
          <KenRadioGroup
            ...
            defaultValue={() =>
              setFieldValue('assessmentGraded', assessmentGradedArray[0])
            }
      ...
      <Grid item md={6} sm={10} className={classes.KenInputsMargin}>
        {/* <Grid item xs={12} sm={2}>
          <KenSelect
            ...
            defaultValue={() => { setFieldValue('totalMarks', TotalMarks[0].value) }}
            setFieldTouched={setFieldTouched}
            name="totalMarks"
            variant="outline"
        ...
        <Grid md={6} sm={6} item className={classes.boxMargin}>
          ...
          <Grid sm={12} md={12}>
            <KenInputField
              ...
              name="inputMarks"
              defaultValue={() => {
                setFieldValue('inputMarks', 0);
              }}
              onChange={newValue => {
                setFieldValue('inputMarks', newValue.target.value);
              }}
      ...
      <Grid item sm={6} className={classes.KenInputsMargin}>
        <KenSelect
          ...
          defaultValue={() => {
            setFieldValue('attemptsAllowed', AttemptsAllowed[1].value);
          }}
      ...
      <Grid item sm={6} className={classes.KenInputsMargin}>
        <KenSelect
          ...
          defaultValue={() => {
            setFieldValue('gradeMethod', GradeMethods[0].value);
          }}
          setFieldTouched={setFieldTouched}
          name="gradeMethod"
