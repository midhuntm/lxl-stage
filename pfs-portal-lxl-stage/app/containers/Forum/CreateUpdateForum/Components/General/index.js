...
export default function General(props) {
  const { values, setValues, touched, errors, handleChange, setFieldTouched, setFieldValue, operation } = props;
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12}>
          <KenInputField
            ...
            label={t('labels:Forum_Name')}
            placeholder="Enter title name"
            value={values.forumName}
            name="forumName"
            onChange={change.bind(null, 'forumName')}
            errors={errors?.forumName}
            setFieldTouched={setFieldTouched}
            touched={touched?.forumName}
          />
        </Grid>
        {values.operation?.toLowerCase() === 'create' && (
          <>
        ...
        <Grid item xs={12} sm={12} md={12}>
          <KenEditor
            ...
            label={t('labels:Forum_Description')}
