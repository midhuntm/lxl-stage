...
// icons
const ExcelIcon = 'https://inazstgpfs3001.blob.core.windows.net/assets/Icons/LMS/excelIcon.svg';
const WordIcon = 'https://inazstgpfs3001.blob.core.windows.net/assets/Icons/LMS/lms-wordFile-icon.png';
const URLIcon = 'https://inazstgpfs3001.blob.core.windows.net/assets/Icons/LMS/link-icon.svg'
...
export default function ActivityCard(props) {
  ...
  const previewResource = selectedItem => {
    ...
    let sectionDataSend = {
      accountname: selectedItem?.connectionData?.fullname,
      section: selectedItem?.connectionData?.section,
      hed__Course__cName: selectedItem?.connectionData?.shortname,
    };
    history.push({
